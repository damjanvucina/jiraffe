...
public class StopBranchTrackingAction extends AnAction {

    public StopBranchTrackingAction() {
        super();
    }

    public StopBranchTrackingAction(@Nullable String text, @Nullable String description, @Nullable Icon icon) {
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        VCSManager.getBranchTracker().stopTracking();

        String dialogTitle = "Tracking Stopped";
        String dialogMessage = "Stopped tracking checked out branch.";
